...
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 3.31 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 3.04 KiB (runtime) [entry] [rendered]
  > ./example.js main
