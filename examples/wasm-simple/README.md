...
```
asset output.js 12.7 KiB [emitted] (name: main)
...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.3 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.03 KiB (runtime) [entry] [rendered]
  > ./example.js main
