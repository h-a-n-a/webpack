...
class ModuleGraph {
	constructor() {
		/** @type {WeakMap<Dependency, ModuleGraphConnection>} 每一个 dependency 都对应了一个 Connection, 如是 entry module 则 connection.originalModule === null  */
	...
	getExportsInfo(module) {
		// exports info of a module is stored on `ModuleGraphModule`
		const mgm = this._getModuleGraphModule(module);
		return mgm.exports;
	}
