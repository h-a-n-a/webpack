...
class HarmonyImportDependency extends ModuleDependency {
	 ...
	 * @returns {string} name of the variable for the import, // var (_foo__WEBPACK_IMPORTED_MODULE_0__) = __webpack_require__ (in the brackets before)
	 */
...
HarmonyImportDependency.Template = class HarmonyImportDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		// index.js(originalModule) -> import "./foo.js"(index.js) -> foo.js(module)
