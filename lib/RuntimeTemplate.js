...
class RuntimeTemplate {
	...
	importStatement({
		...
		// get exports types from an importStatement: eg. import * as foo from "./foo", means the `exportsType` equals to `"namespace"`
	 ...
	 * @param {string} options.importVar the identifier name of the import variable, things like: _foo__WEBPACK_IMPORTED_MODULE_0__
